...
<body>
    ...
    $sql = 'SELECT s.pib, g.group_name,k.pib_kuratora FROM students AS s INNER JOIN groups AS g	ON s.group_id = g.id INNER JOIN kurators AS k ON g.kurator_id = k.id ORDER BY s.pib';
